...
public static class UnityMCPAutoStarter
{
    ...
    private static void Initialize()
    {
        ...
        try
        {
            ...
            Debug.Log("[UnityMCPAutoStarter] Starting Unity MCP Bridge system");
    ...
    private static void EnsureBridgeIsRunning()
    {
        ...
        // If no bridge exists, create it
        if (_bridgeInstance == null)
        {
            Debug.Log("[UnityMCPAutoStarter] Creating new bridge instance");
            ...
            // Move completely off-screen and minimize
            ...
            EditorApplication.delayCall += () => {
                if (_bridgeInstance != null) {
                    _bridgeInstance.position = new UnityEngine.Rect(-2000, -2000, 1, 1);
                    // Auto-start the server after window is properly initialized
        ...
        {
            Debug.Log("[UnityMCPAutoStarter] Using existing bridge instance");
            ...
            EditorApplication.delayCall += () =>
            {
                ...
                {
                    _bridgeInstance.StartServerIfNotRunning();
                    Debug.Log("[UnityMCPAutoStarter] Unity MCP Bridge server started");
                }
            };
        }
    }
